(function personaLedFaqs() {
  ...
  const pages = {
    ...
    "Awakening-Your-Inner-Light-2026.dc.html": [
      ...
      q("Does the retreat include ayahuasca or other plant-medicine ceremonies?", "Yes. The retreat includes plant-medicine and ayahuasca ceremonies. Participation requires explicit informed consent, lawful and authorised provision, contraindication screening, facilitator approval, and the right to decline any practice."),
      ...
      q("What support is provided before and after?", "Preparation and integration support are part of the retreat. Accepted participants receive the exact call schedule, facilitator availability, emergency contacts, and follow-up details in writing."),
