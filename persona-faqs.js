(function personaLedFaqs() {
  ...
  const pages = {
    ...
    "Awakening-Your-Inner-Light-2026.dc.html": [
      ...
      q("How is suitability considered?", "Relevant physical health, medication, mental-health history, pregnancy status, previous psychedelic experience, support needs, and other contraindications can affect suitability. Answer screening questions honestly and never stop or change prescribed medication in order to attend."),
      ...
      q("What is included in the week?", "The published program includes six nights’ accommodation, three meals daily, yoga, breathwork, sound-based practice, three ayahuasca ceremonies, cacao and Bobinsana tea rituals, Temazcal, jungle exploration, sharing circles, and preparation and integration guidance. Final inclusions are confirmed in writing before payment."),
