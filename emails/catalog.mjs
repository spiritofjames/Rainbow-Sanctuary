...
export const emailCatalog = [
  ...
  define({
    ...
    subject: "Your Regeneration Maintenance registration is confirmed", variables: ["NAME", "COMMITMENT", "EVENT_DATE", "EVENT_TIME", "TIMEZONE", "SESSION_DATES", "REFERENCE_ID"],
    content: (x) => ({ preheader: "Your Regeneration Maintenance commitment is confirmed.", eyebrow: "Registration confirmed", heading: "Your place in the cycle is held.", greeting: `Hello ${x("NAME")},`, paragraphs: ["Your Regeneration Maintenance registration is confirmed. The practice is held remotely while participants rest; there is no Zoom session or live attendance requirement.", "Please have a light dinner beforehand and create a quiet, comfortable space for the scheduled time. A Rainbow Sanctuary team member may contact you on WhatsApp if a practical detail needs clarification."], details: [{ label: "Commitment", value: x("COMMITMENT") }, { label: "Start date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }, { label: "Your included dates", value: x("SESSION_DATES") }, { label: "Reference", value: x("REFERENCE_ID") }], callout: "The opening cycle runs weekly through Monday, 2 November 2026. Future twice-monthly dates are shared with registered participants once confirmed." })
  }),
  define({
