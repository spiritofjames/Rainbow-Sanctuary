...
export const emailCatalog = [
  ...
  define({
    ...
    subject: "Your Regeneration Maintenance registration is confirmed", variables: ["NAME", "EVENT_DATE", "EVENT_TIME", "TIMEZONE", "REFERENCE_ID"],
    content: (x) => ({ preheader: "Your Regeneration Maintenance session is confirmed.", eyebrow: "Registration confirmed", heading: "Your session is held.", greeting: `Hello ${x("NAME")},`, paragraphs: ["Your Regeneration Maintenance registration is confirmed. The practice is held remotely while participants rest; there is no Zoom session or live attendance requirement.", "Please have a light dinner beforehand and create a quiet, comfortable space for the scheduled time. A Rainbow Sanctuary team member may contact you on WhatsApp if a practical detail needs clarification."], details: [{ label: "Date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }, { label: "Reference", value: x("REFERENCE_ID") }], callout: "The initial cycle is weekly through 16 November 2026. Future twice-monthly dates are published once confirmed." })
  }),
  define({
