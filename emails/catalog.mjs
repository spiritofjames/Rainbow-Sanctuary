...
export const emailCatalog = [
  ...
  define({
    ...
    subject: "Your Rainbow Sanctuary booking is confirmed", variables: ["NAME", "EVENT_TITLE", "EVENT_DATE", "EVENT_TIME", "TIMEZONE", "LOCATION", "ACCESS_URL", "CALENDAR_URL", "REFERENCE_ID"],
    content: (x) => ({ preheader: "Your place is confirmed. Your private Zoom link is ready.", eyebrow: "Booking confirmed", heading: "Your place is held.", greeting: `Hello ${x("NAME")},`, paragraphs: [`Your booking for ${x("EVENT_TITLE")} is confirmed. We look forward to holding this time with you.`, "Your private Zoom link is below. Please review the time and timezone carefully, and do not forward the link."], details: [{ label: "Date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }, { label: "Location", value: x("LOCATION") }, { label: "Reference", value: x("REFERENCE_ID") }], cta: { label: "Join the Zoom session", url: x("ACCESS_URL") }, secondaryCta: { label: "Add to calendar", url: x("CALENDAR_URL") } })
  }),
  define({
