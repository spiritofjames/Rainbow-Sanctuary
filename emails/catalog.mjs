...
export const emailCatalog = [
  ...
  define({
    alias: "rs-regeneration-maintenance-confirmed", name: "RS · Regeneration Maintenance confirmed", event: "rs.regeneration_maintenance.registered", identity: "bookings",
    subject: "Your {{{PROGRAM_NAME}}} registration is confirmed", variables: ["NAME", "PROGRAM_NAME", "COMMITMENT", "EVENT_DATE", "EVENT_TIME", "TIMEZONE", "SESSION_DATES", "REFERENCE_ID"],
    content: (x) => ({ preheader: `${x("PROGRAM_NAME")} registration confirmed.`, eyebrow: "Registration confirmed", heading: "Your place in the cycle is held.", greeting: `Hello ${x("NAME")},`, paragraphs: [`Your registration for ${x("PROGRAM_NAME")} is confirmed. The practice is held remotely while participants rest; there is no Zoom session or live attendance requirement.`, "Please have a light dinner beforehand and create a quiet, comfortable space for the scheduled time. A Rainbow Sanctuary team member may contact you on WhatsApp if a practical detail needs clarification."], details: [{ label: "Programme", value: x("PROGRAM_NAME") }, { label: "Commitment", value: x("COMMITMENT") }, { label: "Start date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }, { label: "Your included dates", value: x("SESSION_DATES") }, { label: "Reference", value: x("REFERENCE_ID") }], callout: "The opening cycle runs weekly through Monday, 2 November 2026. Future twice-monthly dates are shared with registered participants once confirmed." })
  }),
  define({
    alias: "rs-regeneration-maintenance-day-of-reminder", name: "RS · Regeneration Maintenance day-of reminder", event: "rs.regeneration_maintenance.reminder.day_of", identity: "bookings",
    subject: "Tonight: your Regeneration Maintenance practice", variables: ["NAME", "EVENT_DATE", "EVENT_TIME", "TIMEZONE"],
    content: (x) => ({ preheader: "A gentle reminder for this evening's remote practice.", eyebrow: "Today’s reminder", heading: "The practice is held tonight.", greeting: `Hello ${x("NAME")},`, paragraphs: ["This is a gentle reminder that your Regeneration Maintenance practice is held this evening.", "There is nothing to join: no Zoom room, live call, online check-in, or attendance is required from you. If helpful, have a light dinner beforehand and make space for a quiet, comfortable evening."], details: [{ label: "Date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }], callout: "Your registration has already been recorded. This email is simply a practical reminder for tonight." })
  }),
  define({
    alias: "rs-kids-weekly-practice-confirmed", name: "RS · Children’s Weekly Practice confirmed", event: "rs.kids_weekly_practice.registered", identity: "bookings",
    subject: "Your child’s weekly practice enrolment is confirmed", variables: ["NAME", "CHILD_NAME", "COMMITMENT", "SESSION_DATES", "EVENT_TIME", "TIMEZONE", "ACCESS_URL", "REFERENCE_ID"],
    content: (x) => ({ preheader: "Your child’s weekly Zoom practice details are ready.", eyebrow: "Enrolment confirmed", heading: "Your child’s place is held.", greeting: `Hello ${x("NAME")},`, paragraphs: [`${x("CHILD_NAME")} is confirmed for Children’s Weekly Practice — ${x("COMMITMENT")}. The series is held live on Zoom each Saturday.`, "Please prepare a blindfold, water, and your child’s home-practice set. Join a few minutes early from a calm, comfortable space."], details: [{ label: "Included dates", value: x("SESSION_DATES") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }, { label: "Reference", value: x("REFERENCE_ID") }], callout: "This Zoom access is for the registered family only. Please do not forward the link or share it with other households.", cta: { label: "Open Children’s Weekly Practice Zoom", url: x("ACCESS_URL") } })
  }),
  define({
    alias: "rs-kids-weekly-practice-reminder-1h", name: "RS · Children’s Weekly Practice one-hour reminder", event: "rs.kids_weekly_practice.reminder.1h", identity: "bookings",
    subject: "Starting in one hour: Children’s Weekly Practice", variables: ["NAME", "CHILD_NAME", "EVENT_DATE", "EVENT_TIME", "TIMEZONE", "ACCESS_URL"],
    content: (x) => ({ preheader: "Children’s Weekly Practice begins in approximately one hour.", eyebrow: "Starting soon", heading: "We meet in one hour.", greeting: `Hello ${x("NAME")},`, paragraphs: [`Children’s Weekly Practice begins in approximately one hour for ${x("CHILD_NAME")}.`, "Please have a blindfold, water, and the home-practice set ready. Join from a calm, supervised space when you are ready."], details: [{ label: "Date", value: x("EVENT_DATE") }, { label: "Time", value: x("EVENT_TIME") }, { label: "Timezone", value: x("TIMEZONE") }], cta: { label: "Join Children’s Weekly Practice", url: x("ACCESS_URL") } })
  }),
  define({
  ...
  define({
    alias: "rs-session-review-request", name: "RS · Share your experience", event: "rs.session.review_requested", identity: "bookings",
    subject: "Would you share your experience with Rainbow Sanctuary?", variables: ["NAME", "SESSION_NAME", "REVIEW_URL"],
    content: (x) => ({ preheader: "An optional invitation to share your experience independently.", eyebrow: "Your experience", heading: "Would you share an honest review?", greeting: `Hello ${x("NAME")},`, paragraphs: [`Thank you for taking part in ${x("SESSION_NAME")}. If you feel comfortable, we would value an honest account of your experience on Trustpilot.`, "There is no expected rating or outcome. A positive, critical, or mixed review is equally welcome, and choosing not to leave a review will not affect your relationship with Rainbow Sanctuary."], callout: "Please do not include private health, personal, or session details that you would not want to be public. Trustpilot is an independent public platform, and its own terms and privacy policy apply.", cta: { label: "Share your experience on Trustpilot", url: x("REVIEW_URL") } })
  }),
  define({
  ...
  define({
    alias: "rs-retreat-booking-confirmed", name: "RS · Retreat booking payment received", event: "rs.retreat.booking_confirmed", identity: "bookings",
    subject: "Your {{{RETREAT_NAME}}} payment has been received", variables: ["NAME", "RETREAT_NAME", "RETREAT_DATES", "RETREAT_LOCATION", "PAYMENT_OPTION", "REFERENCE_ID", "RETREAT_URL"],
    content: (x) => ({ preheader: "Your payment has been recorded for the retreat.", eyebrow: "Payment received", heading: "Your booking payment is recorded.", greeting: `Hello ${x("NAME")},`, paragraphs: [`Thank you. We have received your ${x("PAYMENT_OPTION")} payment for ${x("RETREAT_NAME")}.`, "Stripe will send your official payment receipt separately. A Rainbow Sanctuary bookings team member will email your written confirmation, further retreat details, and the next practical steps. Please do not book travel until you receive that confirmation."], details: [{ label: "Retreat", value: x("RETREAT_NAME") }, { label: "Dates", value: x("RETREAT_DATES") }, { label: "Location", value: x("RETREAT_LOCATION") }, { label: "Payment option", value: x("PAYMENT_OPTION") }, { label: "Reference", value: x("REFERENCE_ID") }], callout: "If your health, medication, travel, or participation circumstances have changed, please tell the bookings team before the retreat. Your payment does not replace the required agreements, screening, informed consent, or final written confirmation.", cta: { label: "View retreat information", url: x("RETREAT_URL") } })
  }),
  define({
